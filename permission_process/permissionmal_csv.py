...
def transition_csv(permissionList):
    ...
    permission_malware.to_csv(r'E:\VS\correlation_process\permission_malware.csv', encoding='utf-8', index=False)

def permission_csv():
    permissionAll_dir = r'E:\VS\correlation_process\permissionPeaList.csv'
    root_dir = r'E:\VS\malware\all_non_repeat'
    permission_dir = r'E:\VS\correlation_process\permission_malware.csv'
    permissionList = []
    count_all = []
    count = 0
