...
def transition_csv(hardwareList):
    ...
    hardware_malware.to_csv(r'E:\VS\correlation_process\hardware_benign.csv', encoding='utf-8', index=False)

def hardware_csv():
    hardwareAll_dir = r'E:\VS\correlation_process\hardwarePeaList.csv'
    root_dir = r'E:\VS\benign\all_non_repeat'
    hardware_dir = r'E:\VS\correlation_process\hardware_benign.csv'
    hardwareList = []
    count_all = []
    count = 0
